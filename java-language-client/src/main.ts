...
// @ts-ignore
import helloJavaCode from '/Users/dy/Workspace/jdt-ls-demo/src/main/java/top/dyang/ls/Main.java?raw';
import {configureMonacoWorkers} from './utils.js';

export const runEclipseJdtLsClient = () => {
    const helloJavaUri = vscode.Uri.file(`${eclipseJdtLsConfig.basePath}/src/main/java/top/dyang/ls/Main.java`);
    ...
    const userConfig: WrapperConfig = {
        ...
        editorAppConfig: {
            ...
            codeResources: {
                main: {
                    text: helloJavaCode,
                    uri: `${eclipseJdtLsConfig.basePath}/src/main/java/top/dyang/ls/Main.java`
                }
            },
            useDiffEditor: false,
